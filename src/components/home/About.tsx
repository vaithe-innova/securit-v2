      ...
      <section className="dark:bg-background-6 overflow-hidden bg-blue-light pt-20 pb-14">
        <div className="main-container">
          ...
          <RevealAnimation delay={0.2}>
            <span className="badge badge-blue">Industries</span>
          </RevealAnimation>
          <div>
            <RevealAnimation delay={0.3}>
              <h2 className="mb-3 max-w-[900px] mx-auto" >Built for environments where safety moves fast</h2>
            </RevealAnimation>
            <RevealAnimation delay={0.4}>
              <p className="text-secondary/60 dark:text-accent/60 mx-auto max-w-[1024px]">

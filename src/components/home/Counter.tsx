  ...
  return (
    <section className="pt-16 md:pt-20 lg:pt-[90px] xl:pt-[100px] pb-16 md:pb-20 lg:pb-[90px] xl:pb-[100px] bg-white">
      <div className="main-container">
          <div className="mb-10 grid grid-cols-12 space-y-8 md:gap-8 md:space-y-0 xl:mb-1">
            <div className="col-span-12 md:col-span-6 lg:col-span-7">
              <div className="space-y-3 max-w-[640px]">
                ...
                <RevealAnimation delay={0.2}>
                  <h2 className='fs-36 fw-700 text-primary-700 max-w-[1024px] text-3xl lg:text-4xl'>Preventable incidents still happen—not because teams lack data, but because they can’t act on it fast enough.</h2>
                </RevealAnimation>
              </div>
              </div>

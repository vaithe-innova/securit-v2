              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-10 lg:gap-8">
                ...
                <div className="gap-2 flex flex-col items-start lg:pr-10">
                  ...
                  <div className="space-y-3 md:space-y-5 text-left">
                    <RevealAnimation delay={0.2}>
                      <h1 className="max-w-[700px] text-primary-700 fw-700 tracking-tight !leading-[40px] md:!leading-[56px] lg:!leading-[58px] xl:!leading-[60px] text-4xl md:text-5xl xl:text-[48px]">
                        The smartest way to <span className='text-primary-500'>eliminate the cost </span> of "what if."
                      </h1>
                    </RevealAnimation>
                    <RevealAnimation delay={0.3}>
                      <p className="mx-auto max-w-[800px] text-base sm:text-[18px] lg:text-[20px] text-secondary font-normal !leading-[26px] lg:!leading-[30px]">
                        Safety incidents do more than hurt people—they halt progress. Securit integrates seamlessly into your workflow to prevent downtime, reduce insurance premiums, and protect your bottom line. Invest in a system where zero incidents means 100% productivity.
                      </p>
                    </RevealAnimation>
                  </div>
                  <ul className="flex flex-col gap-y-3 w-full sm:w-auto sm:flex-row sm:gap-x-4 pt-5 sm:pt-8 md:pt-9 lg:pt-10 xl:pt-[46px]">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-10 lg:gap-8">
                <div className="gap-2 flex flex-col items-start lg:pr-10">
                  ...
                  <div className="space-y-3 md:space-y-5 text-left">
                    ...
                    <RevealAnimation delay={0.3}>
                      <p className="mx-auto max-w-[800px] text-base sm:text-[18px] lg:text-[20px] text-secondary font-normal !leading-[26px] lg:!leading-[30px]">
                        You can’t manage what you can’t see. Securit provides a high-definition view of your entire workforce’s safety status. From remote zones to high-risk areas, our AI-powered location intelligence ensures that no worker is ever truly alone and no risk goes unnoticed.
                      </p>
                    </RevealAnimation>
                  </div>
                  <ul className="flex flex-col gap-y-3 w-full sm:w-auto sm:flex-row sm:gap-x-4 pt-5 sm:pt-8 md:pt-9 lg:pt-10 xl:pt-[46px]">

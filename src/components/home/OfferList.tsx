            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
                {offerData.map((offer, index) => (
                    <RevealAnimation key={offer.slug} delay={0.15 + index * 0.12} direction="up" offset={50}>
                        <div className="group relative bg-white hover:bg-[#050B15] border border-[#155DFC66] h-full rounded-[24px] overflow-hidden transition-all duration-500 ease-in-out">
                            <div className="p-6 sm:p-8 md:p-10 text-left h-full transition-all duration-500">
                                <div className="w-[52px] h-[52px] bg-primary-500 rounded-[12px] flex items-center justify-center mb-5 sm:mb-8 transition-transform duration-300">
                                ...
                                <div className='space-y-4'>
                                    ...
                                    <p className="text-black transition-colors duration-500 group-hover:text-[#DBEAFE] text-[14px] lg:text-[16px] !leading-[26px]">{offer.description}</p>
                                </div>
                            </div>
                        </div>
                    </RevealAnimation>

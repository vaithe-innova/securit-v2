...
const StartFree = () => {
  return (
    <section className="bg-[#004AA9] dark:bg-primary-900 pt-16 pb-16 md:pt-20 md:pb-20 lg:pt-[80px] lg:pb-[80px]">
        ...
        <div className="text-center space-y-6">
          ...
          <RevealAnimation delay={0.5}>
            <div className="pt-2">
              <Link
                href="#contact"
                className="inline-flex items-center justify-center bg-white text-[#004AA9] font-bold text-[15px] md:text-[16px] px-8 py-3 rounded-full hover:bg-primary-50 transition-colors duration-300 shadow-lg"
              >
                Get Started Free
              </Link>
            </div>

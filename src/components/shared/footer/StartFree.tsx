...
">
          <div className="space-y-6 text-left max-w-[746px] relative z-20">
            <RevealAnimation delay={0.1} animationType="skew-in" direction="left" offset={80}>
              <h2 className="text-[#FFFFFF] fw-700 text-[22px] sm:text-[28px] md:text-[32px] lg:text-[36px] xl:text-[40px] !leading-[28px] sm:!leading-[36px] md:!leading-[40px] lg:!leading-[46px] group-hover:scale-[1.01] transition-transform duration-700">

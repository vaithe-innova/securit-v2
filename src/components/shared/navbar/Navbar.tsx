    ...
    <MobileMenuProvider>
      <header
        ...
        <RevealAnimation direction="up" offset={100} delay={0.1} instant>
          <div
            className={cn(
              'border-stroke-2 dark:border-stroke-6 bg-accent dark:bg-background-9 mx-auto flex items-center justify-between md:justify-around border-b-2 px-2.5 py-2.5 xl:py-0',
            )}>
            <div className="flex items-center justify-center">
              <Link href="/" className="inline-flex items-center">
                ...
                <figure className="block max-w-[120px] lg:hidden">
                  <Image src={mainLogo} alt="Securit" className="block h-auto w-full dark:hidden" priority />
                  <Image src={mainLogo} alt="Securit" className="hidden h-auto w-full dark:block" priority />
                </figure>
              </Link>
            </div>
            ...
            <div className="hidden items-center justify-center xl:flex">
              <Link href="/demo" className="btn btn-md btn-primary hover:btn-white-dark dark:hover:btn-white mr-6 font-bold h-8 w-[95px] leading-6 py-1 px-2 transition-transform duration-200 !hover:scale-100">
                <span>Get Demo</span>
              </Link>

        ...
        <RevealAnimation delay={0.3}>
          <div className="space-y-3">
            ...
            <div className="space-y-7">
              <p>
                This site, securit.app (hereafter referred to as Securit, site, or website) is owned and operated by
                Innova Solutions (hereafter referred to as Securit, we, or company).
              </p>
              <p>
                Please carefully read, review, and understand our Terms and Conditions before using any services or
                products from securit.app. Your access to and use of this website and its products indicate that you
        ...
        <article className="terms-conditions-body">
          <RevealAnimation delay={0.4}>
            <div className="space-y-6">
              ...
              <p>
                Under no circumstances shall Securit be liable for any direct, indirect, incidental, special, or
                consequential damages, including but not limited to loss of data, profits, or business interruption,
                arising out of the use, or inability to use, the materials on this site, even if Securit or an
          ...
          <RevealAnimation delay={0.5}>
            <div className="space-y-6">
              <h3>2. License</h3>
              <p>
                Securit services, platforms, and tools are provided under a commercial license agreement. Each
              ...
              <p>
                ...
                redistribute, or offer Securit products or services, modified or unmodified, without our written
                consent.
              </p>
            </div>
          </RevealAnimation>
          <RevealAnimation delay={0.6}>
            <div className="space-y-6">
              ...
              <p>
                All Securit products, solutions, and materials remain the intellectual property of Securit
              ...
              <p>
                ...
                implied. Securit is not liable for any losses or damages resulting from the use or inability to use its
                products.
              </p>
              <p>
          ...
          <RevealAnimation delay={0.3}>
            <div className="space-y-6">
              ...
              <p>
                We believe you&apos;ll love Securit! Still, if you&apos;re not satisfied, we offer a 14-day
          ...
          <RevealAnimation delay={0.5}>
            <div className="space-y-6">
              <h3>5. Warranty</h3>
              <p>
                Securit services are provided without any warranty, either expressed or implied. We do not guarantee
          ...
          <RevealAnimation delay={0.6}>
            <div className="space-y-6">
              ...
              <p>
                Securit reserves the right to suspend or terminate any user account without prior notice for reasons
                including but not limited to
              </p>
              <ul>
                <li>Abusive, defamatory, or malicious behavior towards Securit staff or customers</li>
          ...
          <RevealAnimation delay={0.3}>
            <div className="space-y-6">
              ...
              <p>
                We value your privacy. Securit  does not sell, rent, or share your personal information with third
              ...
              <p>
                By using Securit services, you consent to the collection and use of your data by our Privacy Policy.
              </p>
            </div>
          </RevealAnimation>
          <RevealAnimation delay={0.4}>
